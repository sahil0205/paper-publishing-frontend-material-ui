        ...
        return (
            <div className={classes.root}>
                ...
                <main className={classes.content}>
                    <div className={classes.toolbar} />
                    <Typography variant="h5" style={{ paddingLeft: '10px' }}>Paper List</Typography>
                            ...
                            <TableBody style={{ background: 'linear-gradient(65deg, #F7DC6F 100%, #21CBF3 0%)', }}>
                                {
                                    this.state.paperList.map(paper => (
                                        <TableRow key={paper.paperId}>
                                            ...
                                            <TableCell align="center">{paper.editor.userName}</TableCell>
...
export default withStyles(styles, { withTheme: true })(PaperHome);
